...
class Nexus:
	...
	async def pylonLocations(self):
		...
		if self.game.units(MINERALFIELD).closer_than(15, self.unit):
			
			mins = self.game.units(MINERALFIELD).closer_than(15, self.unit)
			vasp = self.game.units(VESPENEGEYSER).closer_than(15, self.unit)
